...
class BaseInferencer:
    ...
    def __init__(self, model_path, edgetpu=True):
       # experimental_delegates = [tflite.load_delegate('libedgetpu.so.1')] if edgetpu else None
        print("pathed")
...
class FaceAligner:
    ...
    def align(self, image, landmarks):
        ...
        print(tuple(eye_center), eye_center.shape)
...
class FacePoseDecoder:
    ...
    def solve(self, landmarks):
        landmarks = landmarks.astype(np.float64).reshape(-1, 2)
